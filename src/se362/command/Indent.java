...
public class Indent {
    ...
    public void indentSelected() {
        if (editor.getActiveFileWindow().getSelectedText() != null) {
            ...
            int start = editor.getActiveFileWindow().getTextArea()
                    .getSelectionStart();
            int end = editor.getActiveFileWindow().getTextArea()
                    .getSelectionEnd();

            editor.getActiveFileWindow().getTextArea()
                    .replaceRange(selected, start, end);

            int newLine = editor.getActiveFileWindow().getAllText()
                    .indexOf("\n");
            ...
            int cursor = editor.getActiveFileWindow().getTextArea()
                    .getCaretPosition();
