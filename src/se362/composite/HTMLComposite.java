...
/**
 * HTMLComposite A html node that may have children, and have both an opening
 * and closing tag.
 */
public class HTMLComposite extends HTMLComponent {
     ...
     * 
     * @param tag
     *            html tag that may be opening/closing.
     * @param parent
     *            reference to parent node for checking if closing tag is
     *            complete.
     */
     ...
     * 
     * @param child
     *            node to add to parent node in tree structure.
